...
public class MdbSpringBootApplication implements CommandLineRunner{
	...
	void createGroceryItems() {
		...
		groceryItemRepo.save(new GroceryItem("1", "Whole Wheat Biscuit", 5, "snacks"));
		groceryItemRepo.save(new GroceryItem("2", "XYZ Kodo Millet healthy", 2, "millets"));
		groceryItemRepo.save(new GroceryItem("3", "Dried Whole Red Chilli", 2, "spices"));
		groceryItemRepo.save(new GroceryItem("4", "Healthy Pearl Millet", 1, "millets"));
		groceryItemRepo.save(new GroceryItem("5", "Bonny Cheese Crackers Plain", 6, "snacks"));
